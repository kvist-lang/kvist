...
run_bench() {
    ...
    "$compiler" "$ROOT/benchmarks/source_backed_arr_helpers.kvist" -o "$generated"
...
odin build "$ROOT/benchmarks/source_backed_arr_helpers_direct.odin" -file -o:speed -out:"$direct_exe"
printf '\n== direct-odin ==\n'
"$direct_exe"
