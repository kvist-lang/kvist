# Experimental: Live Development

Kvist live development is an optional continuity layer on top of a compiled
host. It is separate from the resident reload workflow:

- resident reload swaps compiled code across a stable native boundary
...
The hybrid demo combines resident reload for compiled host/module code with
